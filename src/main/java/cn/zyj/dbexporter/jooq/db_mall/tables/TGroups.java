...
public class TGroups extends TableImpl<TGroupsRecord> {
    ...
    private static final long serialVersionUID = 597212523;
     ...
     */
    public final TableField<TGroupsRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "集团编号");
     ...
     */
    @Override
    public Identity<TGroupsRecord, Integer> getIdentity() {
