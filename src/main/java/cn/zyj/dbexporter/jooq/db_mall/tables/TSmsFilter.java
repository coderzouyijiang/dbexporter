...
public class TSmsFilter extends TableImpl<TSmsFilterRecord> {
    ...
    private static final long serialVersionUID = -424720737;
     ...
     */
    public final TableField<TSmsFilterRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<TSmsFilterRecord, Byte> SYS_TYPE = createField("sys_type", org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>db_mall.t_sms_filter.biz_type</code>.
     */
    public final TableField<TSmsFilterRecord, Byte> BIZ_TYPE = createField("biz_type", org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");
     ...
     */
    @Override
    public Identity<TSmsFilterRecord, Long> getIdentity() {
