...
public class TSmsTemplate extends TableImpl<TSmsTemplateRecord> {
    ...
    private static final long serialVersionUID = 1570385765;
     ...
     */
    public final TableField<TSmsTemplateRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<TSmsTemplateRecord, Integer> getIdentity() {
