...
public class TSmsLog extends TableImpl<TSmsLogRecord> {
    ...
    private static final long serialVersionUID = 1436550956;
     ...
     */
    public final TableField<TSmsLogRecord, Byte> SYS_TYPE = createField("sys_type", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("1", org.jooq.impl.SQLDataType.TINYINT)), this, "");

    /**
     * The column <code>db_mall.t_sms_log.biz_type</code>.
     */
    public final TableField<TSmsLogRecord, Byte> BIZ_TYPE = createField("biz_type", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("1", org.jooq.impl.SQLDataType.TINYINT)), this, "");
