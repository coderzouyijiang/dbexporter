...
public class TEnums extends TableImpl<TEnumsRecord> {
    ...
    private static final long serialVersionUID = -2066870327;
     ...
     */
    public final TableField<TEnumsRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<TEnumsRecord, Integer> getIdentity() {
