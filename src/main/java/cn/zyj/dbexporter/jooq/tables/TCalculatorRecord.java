...
public class TCalculatorRecord extends TableImpl<TCalculatorRecordRecord> {
    ...
    private static final long serialVersionUID = 605520174;
     ...
     */
    public final TableField<TCalculatorRecordRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<TCalculatorRecordRecord, UInteger> getIdentity() {
