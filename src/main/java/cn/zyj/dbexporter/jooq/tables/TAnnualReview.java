...
public class TAnnualReview extends TableImpl<TAnnualReviewRecord> {
    ...
    private static final long serialVersionUID = 742337281;
     ...
     */
    public final TableField<TAnnualReviewRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<TAnnualReviewRecord, UInteger> getIdentity() {
