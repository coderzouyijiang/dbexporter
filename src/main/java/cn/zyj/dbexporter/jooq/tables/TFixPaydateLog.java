...
public class TFixPaydateLog extends TableImpl<TFixPaydateLogRecord> {
    ...
    private static final long serialVersionUID = -309335590;
     ...
     */
    public final TableField<TFixPaydateLogRecord, ULong> ID = createField("id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>db_mall.t_fix_paydate_log.customer_id</code>.
     */
    public final TableField<TFixPaydateLogRecord, ULong> CUSTOMER_ID = createField("customer_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
     ...
     */
    public final TableField<TFixPaydateLogRecord, ULong> ORDER_BILL_ID = createField("order_bill_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>db_mall.t_fix_paydate_log.customer_bill_id</code>.
     */
    public final TableField<TFixPaydateLogRecord, ULong> CUSTOMER_BILL_ID = createField("customer_bill_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
     ...
     */
    @Override
    public Identity<TFixPaydateLogRecord, ULong> getIdentity() {
