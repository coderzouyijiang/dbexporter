...
public class TReleaseFrozenBalance extends TableImpl<TReleaseFrozenBalanceRecord> {
    ...
    private static final long serialVersionUID = 756505394;
     ...
     */
    public final TableField<TReleaseFrozenBalanceRecord, ULong> ID = createField("id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<TReleaseFrozenBalanceRecord, ULong> getIdentity() {
