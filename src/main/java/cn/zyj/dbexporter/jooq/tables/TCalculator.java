...
public class TCalculator extends TableImpl<TCalculatorRecord> {
    ...
    private static final long serialVersionUID = 153905884;
     ...
     */
    public final TableField<TCalculatorRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<TCalculatorRecord, BigDecimal> GROSS_INTEREST_RATE = createField("gross_interest_rate", org.jooq.impl.SQLDataType.DECIMAL(4, 4), this, "毛利率");
     ...
     */
    @Override
    public Identity<TCalculatorRecord, UInteger> getIdentity() {
