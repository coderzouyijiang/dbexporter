...
public class TDepreciation extends TableImpl<TDepreciationRecord> {
    ...
    private static final long serialVersionUID = 557468659;
     ...
     */
    public final TableField<TDepreciationRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<TDepreciationRecord, UInteger> getIdentity() {
