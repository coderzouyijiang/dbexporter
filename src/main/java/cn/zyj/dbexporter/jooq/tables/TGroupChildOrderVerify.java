...
public class TGroupChildOrderVerify extends TableImpl<TGroupChildOrderVerifyRecord> {
    ...
    private static final long serialVersionUID = -718262624;
     ...
     */
    public final TableField<TGroupChildOrderVerifyRecord, ULong> ID = createField("id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "自增主键");
     ...
     */
    @Override
    public Identity<TGroupChildOrderVerifyRecord, ULong> getIdentity() {
