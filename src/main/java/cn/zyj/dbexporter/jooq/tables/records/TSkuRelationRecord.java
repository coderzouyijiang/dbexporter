...
public class TSkuRelationRecord extends UpdatableRecordImpl<TSkuRelationRecord> implements Record6<UInteger, Integer, Integer, Integer, Timestamp, Timestamp> {

    private static final long serialVersionUID = -559375986;
     ...
     */
    public void setGroupResourceId(Integer value) {
        set(1, value);
    }
     ...
     */
    public void setPartResourceId(Integer value) {
        set(2, value);
    }
     ...
     */
    @Override
    public Row6<UInteger, Integer, Integer, Integer, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row6<UInteger, Integer, Integer, Integer, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public TSkuRelationRecord value1(UInteger value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public TSkuRelationRecord values(UInteger value1, Integer value2, Integer value3, Integer value4, Timestamp value5, Timestamp value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TSkuRelationRecord(UInteger id, Integer groupResourceId, Integer partResourceId, Integer productType, Timestamp cdate, Timestamp mdate) {
        super(TSkuRelation.T_SKU_RELATION);
