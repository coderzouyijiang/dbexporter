...
public class TProductRentType extends TableImpl<TProductRentTypeRecord> {
    ...
    private static final long serialVersionUID = -478684012;
     ...
     */
    public final TableField<TProductRentTypeRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<TProductRentTypeRecord, UInteger> getIdentity() {
