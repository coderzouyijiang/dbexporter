...
public class TGroupAccounts extends TableImpl<TGroupAccountsRecord> {
    ...
    private static final long serialVersionUID = -1280828621;
     ...
     */
    public final TableField<TGroupAccountsRecord, ULong> ID = createField("id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<TGroupAccountsRecord, UInteger> GROUP_ID = createField("group_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "所属集团");
     ...
     */
    @Override
    public Identity<TGroupAccountsRecord, ULong> getIdentity() {
