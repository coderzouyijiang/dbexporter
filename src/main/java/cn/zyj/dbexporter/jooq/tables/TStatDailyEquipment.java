...
public class TStatDailyEquipment extends TableImpl<TStatDailyEquipmentRecord> {
    ...
    private static final long serialVersionUID = -1773952380;
     ...
     */
    public final TableField<TStatDailyEquipmentRecord, ULong> ID = createField("id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<TStatDailyEquipmentRecord, ULong> getIdentity() {
