...
public class TBillCheckStart extends TableImpl<TBillCheckStartRecord> {
    ...
    private static final long serialVersionUID = -1309931856;
     ...
     */
    public final TableField<TBillCheckStartRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<TBillCheckStartRecord, UInteger> getIdentity() {
